...
try{
    $sentencia = $db->prepare("SELECT COUNT(estado_ot) FROM orden_servicio WHERE estado_ot = 'abierta'");
    $sentencia->execute();
    $estado_ot_a = $sentencia->fetchColumn();

    $sentencia = $db->prepare("SELECT COUNT(estado_ot) FROM orden_servicio WHERE estado_ot = 'cerrada'");
    $sentencia->execute();
...
try{
    $sentencia = $db->prepare("SELECT COUNT(tipo_mantencion) FROM orden_servicio_cotizacion WHERE tipo_mantencion = 'confeccion y/o reparacion'");
    $sentencia->execute();
    $confec = $sentencia->fetchColumn();

    $sentencia = $db->prepare("SELECT COUNT(tipo_mantencion) FROM orden_servicio_cotizacion WHERE tipo_mantencion = 'preventivo'");
    $sentencia->execute();
    $prev = $sentencia->fetchColumn();

    $sentencia = $db->prepare("SELECT COUNT(tipo_mantencion) FROM orden_servicio_cotizacion WHERE tipo_mantencion = 'correctivo'");
    $sentencia->execute();
    $corr = $sentencia->fetchColumn();

    $sentencia = $db->prepare("SELECT COUNT(tipo_mantencion) FROM orden_servicio_cotizacion WHERE tipo_mantencion = 'otros'");
    $sentencia->execute();
    $otros = $sentencia->fetchColumn();

    $sentencia = $db->prepare("SELECT COUNT(tipo_mantencion) FROM orden_servicio_cotizacion WHERE tipo_mantencion = 'preventivo carta gant'");
    $sentencia->execute();
